...
namespace Stride.Rendering.OcclusionSilhouette
{
    ...
    {
        internal partial class OcclusionSilhouetteEffect  : IShaderMixinBuilder
        {
            public void Generate(ShaderMixinSource mixin, ShaderMixinContext context)
            {
                ...
                context.Mixin(mixin, "OcclusionSilhouetteShader");
            }
            ...
            {
                ShaderMixinManager.Register("OcclusionSilhouetteEffect", new OcclusionSilhouetteEffect());
            }
        }
    }
}
